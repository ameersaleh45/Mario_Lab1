...
##   set_location_assignment PIN_Y12   -to Play_over ;# LEDG8				;#	Reserved
   ...
   set_location_assignment PIN_AE23  -to game_over   ;# LEDR0				;#	Used for indication of slide switch #0
#   set_location_assignment PIN_AF23  -to a[1]   ;# LEDR1				;#	Used for indication of slide switch #1
#   set_location_assignment PIN_AB21  -to a[2]   ;# LEDR2				;#	Used for indication of slide switch #2
#   set_location_assignment PIN_AC22  -to a[3]   ;# LEDR3				;#	Used for indication of slide switch #3
#   set_location_assignment PIN_AD22  -to b[0]   ;# LEDR4				;#	Used for indication of slide switch #4
#   set_location_assignment PIN_AD23  -to b[1]   ;# LEDR5				;#	Used for indication of slide switch #5
#   set_location_assignment PIN_AD21  -to b[2]   ;# LEDR6				;#	Used for indication of slide switch #6
#   set_location_assignment PIN_AC21  -to b[3]   ;# LEDR7				;#	Used for indication of slide switch #7
#   set_location_assignment PIN_AA14  -to c[0]   ;# LEDR8				;#	Used for indication of slide switch #8
#   set_location_assignment PIN_Y13   -to c[1]   ;# LEDR9				;#	Used for indication of slide switch #9
...
##   set_location_assignment PIN_AE12  -to AC_recorded  ;# LEDR16			;#	Used for indication of slide switch #16
  ...
  ;# the group of 4 seven segments on the right
   ...
   set_location_assignment PIN_AF10 -to score[6]   ;# a HEX0S[6]
   set_location_assignment PIN_AB12 -to score[5]   ;# b HEX0S[5]
   set_location_assignment PIN_AC12 -to score[4]   ;# c HEX0S[4]
   set_location_assignment PIN_AD11 -to score[3]   ;# d HEX0S[3]
   set_location_assignment PIN_AE11 -to score[2]   ;# e HEX0S[2]
   set_location_assignment PIN_V14  -to score[1]   ;# f HEX0S[1]
   set_location_assignment PIN_V13  -to score[0]   ;# g HEX0S[0]
...
#
   set_location_assignment PIN_U9   -to lives[6]   ;# a HEX4S[6]
   set_location_assignment PIN_U1   -to lives[5]   ;# b HEX4S[5]
   set_location_assignment PIN_U2   -to lives[4]   ;# c HEX4S[4]
   set_location_assignment PIN_T4   -to lives[3]   ;# d HEX4S[3]
   set_location_assignment PIN_R7   -to lives[2]   ;# e HEX4S[2]
   set_location_assignment PIN_R6   -to lives[1]   ;# f HEX4S[1]
   set_location_assignment PIN_T3   -to lives[0]   ;# g HEX4S[0]
#
